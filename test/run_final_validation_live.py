...
def _cases() -> List[Dict[str, Any]]:
    return [
        ...
        {"id": "03", "bucket": "KB", "query": "What is Grover's algorithm?", "expected_routes": ["ROUTE_UNIGURU", "ROUTE_LLM"]},
        {"id": "04", "bucket": "KB", "query": "What is Shor's algorithm used for?", "expected_routes": ["ROUTE_UNIGURU", "ROUTE_LLM"]},
        ...
        {"id": "08", "bucket": "KB", "query": "Explain Vachanamrut core teachings.", "expected_routes": ["ROUTE_UNIGURU", "ROUTE_LLM"]},
